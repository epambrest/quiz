...
namespace Teams.Data.Migrations
{
    ...
    [Migration("20201120114009_AddTestRun")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Teams.Domain.Answers", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Teams.Domain.TestSample", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("Answers")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Teams.Domain.TestSample", b =>
                {
                    b.HasOne("Teams.Domain.Answers", "SampleAnswers")
                        .WithMany()
                        .HasForeignKey("Answers");

                    b.HasOne("Teams.Domain.ApplicationUser", null)
                        .WithMany("TestsCompleted")
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("Teams.Domain.Question", "SampleQuestion")
                        .WithMany()
